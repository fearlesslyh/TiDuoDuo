...
import com.lyh.TiDuoDuo.model.dto.scoringResult.ScoringResultAddRequest;
import com.lyh.TiDuoDuo.model.dto.scoringResult.ScoringResultEditRequest;
import com.lyh.TiDuoDuo.model.dto.scoringResult.ScoringResultQueryRequest;
import com.lyh.TiDuoDuo.model.dto.scoringResult.ScoringResultUpdateRequest;
...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        List<String> resultProps = scoringResultAddRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(resultProps));
        // 数据校验
    ...
    public BaseResponse<Boolean> updateScoringResult(@RequestBody ScoringResultUpdateRequest scoringResultUpdateRequest) {
        ...
        List<String> resultProps = scoringResultUpdateRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(resultProps));
        // 数据校验
    ...
    public BaseResponse<Boolean> editScoringResult(@RequestBody ScoringResultEditRequest scoringResultEditRequest, HttpServletRequest request) {
        ...
        List<String> resultProps = scoringResultEditRequest.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(resultProps));
        // 数据校验
        scoringResultService.validScoringResult(scoringResult, false);
        User loginUser = userService.getLoginUser(request);
